...
FALLBACK_URLS = {
    ...
    "nextcloud-db-dumper": ("https://github.com/HenkVanHoek/PiSelfhosting"),
...
def main():
    ...
    group_rules = data.get("_piselfhosting", {}).get("group_rules", {})
    group_order = data.get("_piselfhosting", {}).get("group_order", [])
    ...
    lines.append(
        ...
        "using PiSelfhosting, along with links to their official repositories "
        "and homepages."
    )
    lines.append("")
