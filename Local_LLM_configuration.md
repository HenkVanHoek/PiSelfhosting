# Local LLM Configuration: PiSelfhosting Expert

This guide describes the process for configuring a specialized Mistral-based model optimized for the PiSelfhosting codebase on a system with an RTX 3060 (12GB VRAM).

## 1. Create the Model file
Create a text file named piselfhosting.mf using vi. This file contains the parameters and system instructions essential for context stability and architectural quality.
    ...
    SYSTEM """
    You are an expert software architect specialized in the PiSelfhosting project.
...
1. Start a new session with the piselfhosting-expert model.
