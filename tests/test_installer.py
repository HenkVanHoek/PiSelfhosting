...
from piselfhosting_installer import run_installation


class TestInstaller(unittest.TestCase):
    """
    Integration tests for the PiSelfhosting Installer.
    Ensures the installer correctly orchestrates the ArtifactGenerator and Ansible.
    """

    @patch("piselfhosting_installer.ArtifactGenerator")
    @patch("piselfhosting_installer.ComponentReader")
    @patch("piselfhosting_installer.get_project_root")
