    ...
    def scan(self, subnet=None):
        ...
        if subnet is None:
            ...
            if detected_subnet:
                ...
                detection_info = {
                    ...
                    "detected_ip": self.get_primary_ip()[0],
                    "subnet": subnet,
                }
            ...
            detection_info = {"success": True, "method_used": "user_provided", "subnet": subnet}
        ...
        try:
            ...
            if pi_count == 0:
                ...
                messages.append(f"✅ Scan complete: {pi_count} Raspberry Pi(s) discovered")
    ...
    def get_device_details(self, ip_address):
        ...
        try:
            ...
            for line in disk_lines:
                ...
                if len(line_parts) == 6:
                    disks.append(dict(zip(["filesystem", "size", "used", "avail", "pcent", "mounted_on"], line_parts)))
