---
name: github-release
description: Workflows for publishing releases, bumping versions, and tagging code in PiSelfhosting
---

# GitHub Release and Version Bumping Workflow

This skill guides the agent in bumping the version of PiSelfhosting, tagging the code, and triggering the GitHub Release Pipeline.
