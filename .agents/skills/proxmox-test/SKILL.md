---
name: proxmox-test
description: Workflows voor het automatisch testen van PiSelfhosting componenten in een gekloonde Proxmox VM.
---

# Proxmox Component Integration Testing Workflow

Gebruik deze skill om PiSelfhosting componenten te valideren door ze automatisch te deployen en testen op een tijdelijk gekloonde VM binnen een Proxmox VE server.
