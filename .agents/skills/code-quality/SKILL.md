---
name: code-quality
description: Richtlijnen en commando's voor codekwaliteit, linting en unit-testing met pytest, flake8, mypy en pre-commit specifiek voor PiSelfhosting.
---

# Code Kwaliteit & Unit Testing (PiSelfhosting)

Gebruik deze skill om codekwaliteit te garanderen en tests uit te voeren binnen het PiSelfhosting project.
