...
This document is automatically generated from the project metadata. It lists the open-source software packages that can be deployed using PiSelfhosting, along with links to their official repositories and homepages.
...
| Service | Description | Project Homepage / Repository |
|---|---|---|
| Nextcloud DB Dumper | Automated backup container for Nextcloud MariaDB database. | [Link](https://github.com/HenkVanHoek/PiSelfhosting) |
...
| Service Maintenance | Monitor status, updates and vulnerabilities. | [Link](https://github.com/HenkVanHoek/PiSelfhosting) |
