...
This guide documents the setup, architecture, and usage of the separate component repository and AI-assisted tools in PiSelfhosting.
...
The sync manager, defined in [sync_manager.py](file:///home/hvhoek/PycharmProjects/PiSelfhosting/src/managers/sync_manager.py), handles the data flow:
