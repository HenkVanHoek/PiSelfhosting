...
# PiSelfhosting Testing Strategy

This document outlines the testing procedures for the PiSelfhosting project, covering both the Python backend and the JavaScript frontend.
