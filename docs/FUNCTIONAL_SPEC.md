# PiSelfhosting - Functional Specification

This is a living document that defines the functional requirements for the
PiSelfhosting project. It is based on the principles of Behavior-Driven
...
-   **The Developer (Charlie):** A technical user who maintains and extends
    the PiSelfhosting project. Charlie interacts with the **Editor App**
